...
public interface TextConstant {
    ...
    String PRINT_BY_MIN_AGE = "1. Print animals by min age";
    String PRINT_BY_FAMILY = "2. Print animals by family";
    String PRINT_BY_AGE_AND_COLORING = "3. Print animals by age and coloring";
    String EXIT = "4. Exit";
